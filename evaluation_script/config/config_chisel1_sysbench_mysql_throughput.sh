...
vm1_script_phase3="sysbench --skip_trx=on --threads=20  --db-driver=mysql  --mysql-user=akash --mysql-password=iamakash --mysql-db=pandabench --table_size=40000000 --mysql_storage_engine=memory --rand-type=uniform --rand-seed=2 --range_size=10 --point_selects=5000 /home/akash/benchmarks/real/sysbench/src/lua/oltp_read_only.lua run > /home/akash/OpRun.out"
...
vm2_script_phase3="sysbench --skip_trx=on --threads=20  --db-driver=mysql  --mysql-user=akash --mysql-password=iamakash --mysql-db=pandabench --table_size=40000000 --mysql_storage_engine=memory --rand-type=uniform --rand-seed=2 --range_size=10 --point_selects=5000 /home/akash/benchmarks/real/sysbench/src/lua/oltp_read_only.lua run > /home/akash/OpRun.out"
