...
prepare_vm1_script="cd /home/nuksm/nuKSM-artifact/benchmarks/randomAccess;./prepare-workload.sh 600000 30"
...
prepare_vm2_script="cd /home/nuksm/nuKSM-artifact/benchmarks/randomAccess;./prepare-workload.sh 600000 30"
